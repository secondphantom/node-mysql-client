...
export namespace MysqlDataType {
  export type CheckAllowNullUndefined<T> = null extends Extract<
    T,
    null | undefined
  >
    ? "YES"
    : undefined extends Extract<T, null | undefined>
    ? "YES"
    : "NO";

  export type CheckAllowNull<T> = null extends Extract<T, null | undefined>
    ? "YES"
    : "NO";

  export type CheckUndefined<T> = undefined extends Extract<T, null | undefined>
    ? "YES"
    : "NO";
  ...
  type DbAryConfigTableName<T extends any[]> = PickTypeValues<
    TypeValues<GetUnionElementType<T>>,
    "tableName"
  >;
  type DbAryConfigFields<T extends any[]> = PickTypeValues<
    TypeValues<GetUnionElementType<T>>,
    "fields"
  >;
  ...
  export type ObjInferValues<T> = T extends { [key in keyof T]: infer R }
    ? R
    : never;
}
